...
BEGIN
  ...
  -- Grupo Financeiro (raiz, ordem 0)
  INSERT INTO public.menus (user_id, name, slug, icon, order_index, module)
  VALUES (p_user_id, 'Financeiro', 'financeiro', 'DollarSign', 0, 'financeiro')
  ...
  -- Grupo Cadastros (raiz, ordem 1)
  INSERT INTO public.menus (user_id, name, slug, icon, order_index, module)
  VALUES (p_user_id, 'Cadastros', 'cadastros', 'Users', 1, 'cadastros')
  ...
  -- Grupo Configurações (raiz, ordem 2)
  INSERT INTO public.menus (user_id, name, slug, icon, order_index, module)
  VALUES (p_user_id, 'Configurações', 'sistema', 'Settings', 2, 'sistema')
