...
BEGIN
  ...
  INSERT INTO public.menus (user_id, name, slug, icon, route, parent_id, order_index, module) VALUES
    (p_user_id, 'Cadastros Financeiros', 'cadastros-financeiros', 'Settings2', '/app/financas/cadastros', v_fin_config, 0, 'financeiro'),
    (p_user_id, 'Contas Bancárias', 'contas-bancarias', 'Landmark', '/app/financas/contas-bancarias', v_fin_config, 1, 'financeiro');
  ...
  -- Automações (rota direta, sem sub-item "Regras")
  INSERT INTO public.menus (user_id, name, slug, icon, parent_id, order_index, module)
