    ...
    <div className="space-y-6 max-w-5xl animate-fade-in">
      ...
      <div className="w-full">
        ...
        <stripe-pricing-table
          pricing-table-id="prctbl_1TLE55J633HWAlBjLIDqdzsi"
          publishable-key="pk_test_51TFifCJ633HWAlBjiOg67fgb2hPnc0MO5gFCWvNqUE3yXPLQUNPzF9kCwFPt0ZZkNGfez75GX0WAQHVDzwiZ3dy200apPUxMmQ"
        />
      </div>
